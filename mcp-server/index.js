                ...
                contents: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            registeredActions: {
                                loadLocalFile: 'Load file from node property (btLocalFilePath). Static path. Configurable outputType.',
                                fileToMedia: 'Load file from blackboard path (btInputKey). Dynamic path. Always outputs as media.',
                                mediaToFile: 'Save blackboard media to temp file, stores path as text.',
                                playAudio: 'Play audio from blackboard media.',
                                playVideo: 'Play video from blackboard media.',
                                math: 'Evaluate JS expression from btPrompt.',
                                web: 'HTTP request from btPrompt.',
                                misc: 'Misc operations (clipboard, write to BB).',
                            },
                            toolCount: 30,
